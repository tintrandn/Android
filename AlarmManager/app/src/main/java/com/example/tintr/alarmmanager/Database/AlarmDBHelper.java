...
import com.example.tintr.alarmmanager.Database.AlarmColumns.Alarm;
...
public class AlarmDBHelper extends SQLiteOpenHelper {
    ...
    private ContentValues populateContent(AlarmModel model) {
        ...
        values.put(Alarm.COLUMN_NAME_ALARM_REPEAT_DAYS, repeatingDays.toString());
    ...
    public void createAlarm(AlarmModel model) {
        ...
        getWritableDatabase().insert(Alarm.TABLE_NAME, null, values);
    }
    ...
    public void updateAlarm(AlarmModel model) {
        ContentValues values = populateContent(model);
        getWritableDatabase().update(Alarm.TABLE_NAME, values, Alarm._ID + " = ?", new String[]{String.valueOf(model.id)});
    }
